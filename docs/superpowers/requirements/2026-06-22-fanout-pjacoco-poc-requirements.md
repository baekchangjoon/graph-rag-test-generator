...
| REQ-005 | per-request 오버헤드 임계 이내 (동기 flush) | `V3OverheadPoc`, `V3OverheadProductionPoc` | E2E | 🟢 동기 over-threshold → REQ-010 비동기 flush PASS(honest +1.73% cp, 60/60 exec)로 해소. 비동기 채택 = A 진행 조건 충족. 2026-06-23 |
