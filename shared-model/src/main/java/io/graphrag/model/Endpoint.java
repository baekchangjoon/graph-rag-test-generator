...
public record Endpoint(
    ...
    /** 구버전 그래프(errorMessageLiterals 부재)와의 후방 호환: 누락 필드를 빈 값으로 정규화 + 불변 복사. */
    public Endpoint {
        errorMessageLiterals = errorMessageLiterals == null ? List.of() : List.copyOf(errorMessageLiterals);
    }
