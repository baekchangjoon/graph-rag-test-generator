...
// EventuateTramKafkaMessageConsumerConfiguration provides the MessageConsumer bean (Kafka consumer);
// TramConsumerJdbcAutoConfiguration provides duplicate-message detection via SQL.
@Configuration
